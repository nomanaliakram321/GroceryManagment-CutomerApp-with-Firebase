...
import 'package:customer_app/screens/fade_in_animation.dart';
  ...
  getSessionValues() async {
    FirebaseAuth.instance.authStateChanges().listen((User user) {
      if (user == null) {
        ...
        //if user data is in firestore and then check delivery address set or not
...
//chexk if user address exist or not
      if (result.data()['address'] != null) {
        //if address detail exist then
        updataPrefs(result);
      }
      Navigator.pushReplacementNamed(context, LandingScreen.id);
    });
  ...
  Future<void> updataPrefs(result) async {
    ...
    preferences.setString('location', result['location']);
    //after update move to home screen
    Navigator.pushReplacementNamed(
      context,
     NavigationScreen.id
    );
                      ...
                      Container(
                        ...
                        decoration: BoxDecoration(
                            ...
                            image: DecorationImage(
                                image: AssetImage('images/enteraddress.png'),
                                fit: BoxFit.cover)),
                      )),
                )),
            Container(
